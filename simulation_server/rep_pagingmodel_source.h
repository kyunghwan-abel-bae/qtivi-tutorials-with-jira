#ifndef REP_PAGINGMODEL_SOURCE_H
#define REP_PAGINGMODEL_SOURCE_H
...
class PagingModelSource : public QObject
{
    Q_OBJECT
    Q_CLASSINFO(QCLASSINFO_REMOTEOBJECT_TYPE, "PagingModel")
    Q_CLASSINFO(QCLASSINFO_REMOTEOBJECT_SIGNATURE, "1d5fd9948fbbdc4a25c4eb34b28120c580286135")

public:
    explicit PagingModelSource(QObject *parent = nullptr) : QObject(parent)
    {
...
class PagingModelSimpleSource : public PagingModelSource
{
    Q_OBJECT

public:
    explicit PagingModelSimpleSource(QObject *parent = nullptr) : PagingModelSource(parent)
    {
    }

public:
    virtual ~PagingModelSimpleSource() {}
...
struct PagingModelSourceAPI : public SourceApiMap
{
    PagingModelSourceAPI(ObjectType *object, const QString &name = QStringLiteral("PagingModel"))
    ...
    QString typeName() const override { return QStringLiteral("PagingModel"); }
    ...
    QByteArray objectSignature() const override { return QByteArray{"1d5fd9948fbbdc4a25c4eb34b28120c580286135"}; }
...
#endif // REP_PAGINGMODEL_SOURCE_H
